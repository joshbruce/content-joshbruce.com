...
In the game there are four items a user can click on.</i>
...
We could make it smaller, by removing the whitespace and other letters:
...
Brings us to about 100 characters for the HTML (1kb). About 500 for the JS (4kb). 663 all together or 5k still. So, time to first paint on a 14.4k modem is ~0.1 seconds. Time to first interaction is ~0.3 seconds.
...
About 200 more characters (2 more kilobytes, for a total of 7k) and no new functionality.
